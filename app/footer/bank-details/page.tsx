...
export default function BankDetailsPage() {
  ...
  useEffect(() => {
    const fetchBankDetails = async () => {
      try {
        const response = await fetch("/api/bank-details", { cache: "no-store" });
    ...
    return (
      <div className="w-11/12 mx-auto my-10">
        <div className="bg-white rounded-xl p-8 text-center min-h-[400px] flex items-center justify-center">
          <div className="text-gray-600">Loading bank account details...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-xl p-8 text-center min-h-[400px] flex items-center justify-center">
          <div>
            ...
            <p className="text-gray-600">
              Unable to load bank account details at this time.
            </p>
          </div>
        </div>
      </div>
