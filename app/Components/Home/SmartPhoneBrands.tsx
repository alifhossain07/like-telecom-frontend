...
const SmartPhoneBrands = () => {
  ...
  return (
    <div className="w-10/12 p-10 flex mx-auto items-center bg-gray-200 rounded-2xl">
      <div className=" py-10 w-1/2 px-4">
        <h1 className="text-2xl md:text-3xl w-8/12 font-bold text-gray-800 mb-4">
        ...
        <button className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 flex items-center rounded-3xl font-medium transition">
      ...
      {/* Brand Logos */}
      <div className="grid grid-cols-2 items-center w-1/2 sm:grid-cols-3 md:grid-cols-4 gap-6 px-4 ">
