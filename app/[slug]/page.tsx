                ...
                <div className="flex items-center  gap-4">
                  <div className="flex items-center w-[90px] bg-[#f4f4f4] h-[38px] border border-gray-300 rounded overflow-hidden">
                    ...
                    <button
                      ...
                      className="w-[42px] h-[20px] bg-orange-500 rounded-full text-white hover:text-black ml-1 flex items-center justify-center text-lg font-semibold  hover:bg-gray-100 transition"
                    >
                      −
                    </button>
                    ...
                    <button
                      ...
                      className="w-[42px] h-[20px] rounded-full text-white flex bg-orange-500 items-center justify-center text-lg font-semibold  hover:text-black mr-1 hover:bg-gray-100 transition"
                    >
                      +
                    </button>
